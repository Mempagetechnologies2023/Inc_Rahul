...
class _InfluencerboothsState extends State<Influencerbooths> {
  ...
  String _partytitleText = 'चंद्रपुर में प्रभावशाली व्यक्तियों का विवरण';
  ...
  void _updatePartyTitleText() {
    switch (_selectedLocale.languageCode) {
      case 'hi':
        _partytitleText = 'चंद्रपुर में प्रभावशाली व्यक्तियों का विवरण';
        break;
      case 'en':
        _partytitleText = 'Influencers Details in Chandrapur';
        break;
      default:
        _partytitleText = 'चंद्रपुर में प्रभावशाली व्यक्तियों का विवरण';
    }
